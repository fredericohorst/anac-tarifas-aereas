...
def apllying_basic_statistics(dataframe, origem_icao, destino_icao, bs_size):
    ...
    tarifas_count = tarifas_count[['ANO','MES','PERIODO','ORIGEM','DESTINO','TARIFA DEFLACIONADA']]
    ...
    tarifas_sts = tarifas_sts[['ANO','MES','PERIODO','ORIGEM','DESTINO','TARIFA DEFLACIONADA']]
    tarifas_sts.columns = ['ANO','MES','PERIODO','ORIGEM','DESTINO','TARIFA DEFLACIONADA MÉDIA']
    ...
    for periodo in periodos:
        ...
        ic_tarifa_media = basic_statistics.draw_bs_reps(df['TARIFA DEFLACIONADA'], np.mean, size = bs_size)
    ...
    tarifas_sts['TARIFA DEFLACIONADA MÉDIA - PERCENTIL 2,5'] = tarifa_media_percentil_025
    tarifas_sts['TARIFA DEFLACIONADA MÉDIA - PERCENTIL 50'] = tarifa_media_percentil_500
    tarifas_sts['TARIFA DEFLACIONADA MÉDIA - PERCENTIL 97,5'] = tarifa_media_percentil_975
